...
e=cell(m,1);  [e{:}]=deal('0');%valores de la fuentes 
%para la matriz x
...
%% MATRIZ DE VALORES
cellGen = CellMatrixGenerator(fileIn);%Funcion que genera matriz de valores
...
% imprimir valores de la multiplicacion entre A y x para los voltajes
%fprintf('\nThe matrix equation: \n');
%disp(A*x==z)
...
%fprintf('\nThe solution:  \n');% una vez asignado cada valor en su lado del 
% signo igual se imprime
%disp(x==eval(x))
